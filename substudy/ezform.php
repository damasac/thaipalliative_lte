...
$dataFormMain = mysqli_fetch_assoc($queryFormMain);
	...
	//----------------------------------------------------------------------------------------------------------------
		...
		<div class="pull-right">
			<a target="_blank" href="../eform/table2.php?task=public&idFormMain=<?php echo $_GET["idFormMain"]?>" class="btn btn-primary" style="color:white;">ดูตารางข้อมูล</a>
			<a href="?ptid_key=<?php echo $_GET['ptid_key']; ?>" class="btn btn-danger" style="color:white;"><li class="fa fa-times"></li> Close</a>
		</div>  
		    ...
		    ?>
			<form action="../eform/insertdata.php?Redirect=<?php echo base64_encode("emr/?ptid_key=".$_GET['ptid_key']); ?>" method="post" class="form-horizontal" >
			<?php 
