    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo 'http://',$_SERVER['SERVER_NAME'],'/',APP_WEBROOT;?>" class="logo">
          ...
          <span class="logo-lg"><b>Thai Palliative</b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo 'http://',$_SERVER['SERVER_NAME'],'/',APP_WEBROOT;?>patient_register"><i class='fa fa-link'></i> <span>ให้บริการแสสส</span></a></li>
            <li class="treeview">
