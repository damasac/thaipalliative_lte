/* Add New Function By TeeLek 13 Dec 2014 ( Only Add , Don't change any thing ) */
/** 
...
/* ------------------------------------------------ */
/* Add By TeeLek 13 Dec 2014 ---------------------- */
/* to fix Thai Date and LeapYear (29 Feb) Correctly */
/* ------------------------------------------------ */
var datetimepicker_ThaiYear = function (ct) {
/* ------------------------------------------------ */
    var leap=3;
    var dayWeek=["พฤ.", "ศ.", "ส.", "อา.","จ.", "อ.", "พ."];
    var mont=['มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฎาคม', 'สิงหาคม', 'กันยายน', 'ตุลาคม', 'พฤศจิกายน', 'ธันวาคม'];
    if(ct) {
        var yearL=new Date(ct).getFullYear()-543;
        leap=(((yearL % 4 == 0) && (yearL % 100 != 0)) || (yearL % 400 == 0))?2:3;
        if(leap==2){ dayWeek=["ศ.", "ส.", "อา.", "จ.","อ.", "พ.", "พฤ."]; }
    }
    this.setOptions({ i18n:{ th:{dayOfWeek:dayWeek,months:mont}},dayOfWeekStart:leap })
};
/* ---------------------------------------------- */
