<?php
    if($_POST["typeQuestion"]=="textarea"){
        ?>
                <div class="col-lg-4">
   ...
   else if($_POST["typeQuestion"]=="text"){
?>
        <div class="col-lg-4">
    ...
    else if($_POST["typeQuestion"]=="heading"){
        ?>
                <div class="col-lg-12">
                <h4>หัวข้อคำถาม</h4>
                <hr class="hr-form">
        ...
        <?php
    }else if($_POST["typeQuestion"]=="radiobox"){
        ?>
    ...
    <?php 
    ...
    else if($_POST["typeQuestion"]=="radiotextbox"){
      ?>
      <div class="row"  id="inputRadio">
                ...
                <div class="form-inline">
                    <div class="form-group">
                        <label>
                            ...
                            <input type="text" class="form-control"  id="valTextRadio1" value="<?php echo $_POST["valQuestion"]?>_1" style="width:15%;"/>
    ...
    else if($_POST["typeQuestion"]=="checkbox"){
      ?>
            ...
            <div class="col-lg-6 col-lg-offset-2" >
                <div class="form-inline">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="valCheckbox1" value="<?php echo $_POST["valQuestion"]?>_1" style="width:20%;"/>
    ...
    else if($_POST["typeQuestion"]=="select"){
        ?>
            <div class="row">
    ...
    else if($_POST["typeQuestion"]=="date"){
        ?>
        <div class="col-lg-6">
     ...
     else if($_POST["typeQuestion"]=="time"){
        ?>
        <div class="col-lg-3">
     ...
     else if($_POST["typeQuestion"]=="datetime"){
        ?>
        <div class="col-lg-6">
     ...
     else if($_POST["typeQuestion"]=="dbthailand"){
        ?>
        <div class="col-lg-6">
            <div class="checkbox">
                <label >
    ...
    //($_POST["typeQuestion"]=="scale")
    else{
        //echo $_POST["typeQuestion"];
        ?>
         <div class="row">
                <div class="col-lg-6 col-lg-offset-2" id="inputSelect">
                    <div class="form-inline">
